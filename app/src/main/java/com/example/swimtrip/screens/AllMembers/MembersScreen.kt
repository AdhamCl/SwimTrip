...
fun MembersScreen(
    ...
    LazyColumn(
        modifier = Modifier.fillMaxSize().padding(top = 5.dp, start = 2.dp, end = 2.dp, bottom = 5.dp),
        ...
        items(
            ...
            SwipeToDismiss(
                state = dismissState,
                background = { if(dismissDirection==DismissDirection.EndToStart) DeleteBackground(degrees)  else AddBackground(degrees) },
